...
class MainActivity : AppCompatActivity(), ButtonFragment.ButtonInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        hasTwoColumns = findViewById<android.view.View>(R.id.container2) != null
        ...
        if (savedInstanceState == null) {
            ...
            transaction.add(R.id.container1, buttonFragment)
            transaction.commit()
        ...
        // Observe die roll LiveData and switch fragments if in portrait
    ...
    */
    ...
    override fun buttonClicked() {
        // Implement behavior for button click if needed
    }
}
